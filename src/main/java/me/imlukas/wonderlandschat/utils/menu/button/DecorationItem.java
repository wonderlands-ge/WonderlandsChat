...
extends Button {
    public DecorationItem(ItemStack displayItem, Consumer<InventoryClickEvent> clickTask, Consumer<InventoryClickEvent> rightClickTask, Consumer<InventoryClickEvent> leftClickTask, Collection<Placeholder<Player>> placeholders) {
    ...
    public DecorationItem(ItemStack displayItem, Consumer<InventoryClickEvent> clickTask) {
